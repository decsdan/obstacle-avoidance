...
The raw log-odds grid is thresholded to a binary obstacle mask, then the
Euclidean distance transform is computed once and packed as an inflated
``OccupancyGrid``. All global planners consume this shared inflated grid;
none recompute their own inflation.
"""
