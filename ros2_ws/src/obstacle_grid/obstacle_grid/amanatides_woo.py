...
Reference: Amanatides and Woo, *A Fast Voxel Traversal Algorithm for Ray
Tracing*, 1987. Produces the exact sequence of grid cells a ray passes
through, with the parametric entry/exit distances along the ray, so the
log-odds update can weight each cell by its actual path length.
"""
