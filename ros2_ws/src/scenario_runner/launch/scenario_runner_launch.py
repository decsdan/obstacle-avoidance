...
Assumes the rest of the navigation stack (obstacle_grid, global planner,
local planner, nav_server) is already up in another terminal. This
launch is intentionally minimal -- one node with one params file --
because the scenario runner's entire job is to drive an already-running
stack through an episode sequence.
"""
