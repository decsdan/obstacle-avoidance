...
Owns everything scoped to a single episode: scenario spec, subordinate
seeds, HDF5 writer, terminal detector, Navigate goal handle, and the
map-frame pose tracker. Keeping this as a plain Python object lets the
main node host one episode at a time with a clear teardown path.
"""
